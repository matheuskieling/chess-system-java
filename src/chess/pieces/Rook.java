...
public class Rook extends ChessPiece {
    ...
    public boolean[][] possibleMoves() {
        ...
        if (position.getRow() + 1 < mat.length) {
            //below
            p.setValues(position.getRow() + 1, position.getColumn());
            while (getBoard().positionExists(p) && !getBoard().thereIsAPiece(p) && p.getRow() < mat.length) {
                mat[p.getRow()][p.getColumn()] = true;
                p.setRow(p.getRow() + 1);
            }
            if (getBoard().positionExists(p) && isThereOpponentPiece(p)) {
        ...
        if (position.getColumn() + 1 < mat.length) {
            //right
            p.setValues(position.getRow(), position.getColumn() + 1);
            while (getBoard().positionExists(p) && !getBoard().thereIsAPiece(p) && p.getColumn() < mat.length) {
                mat[p.getRow()][p.getColumn()] = true;
                p.setColumn(p.getColumn() + 1);
            }
            if (getBoard().positionExists(p) && isThereOpponentPiece(p)) {
